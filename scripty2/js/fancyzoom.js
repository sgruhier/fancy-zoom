...
var FancyZoomBox = {
  ...
  show: function(e) {
    ...
    FancyZoomBox.zoom.morph('opacity:1; top:' + newTop .px()+ '; left:' + newLeft.px() + ';width:' + width.px() + ';height:' + height.px(), 
                            {
                              before: function() {
                                FancyZoomBox.zoom.show().setStyle({opacity: 0});
  ...
  hide: function(e) {
    e.stop();
		if (FancyZoomBox.zooming) return;
		FancyZoomBox.zooming = true;		
    FancyZoomBox.zoom.morph('opacity:0; top:' + FancyZoomBox.curTop.px()+ '; left:' + FancyZoomBox.curLeft.px() + ';width:' + '1'.px() + ';height:' + '1'.px(), 
                            {
                              before: function() {
                      					FancyZoomBox.fixBackgroundsForIE();
